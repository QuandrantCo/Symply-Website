    ...
    <div class="container-service">
        ...
        <div class="content-service">
            <div class="card-service">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 1" id="myBtn">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 2">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 3">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 4">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 5">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 6">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 7">
                <img src="{{ asset('images/service/service-icon.png') }}" alt="Service 8">
            </div>
        </div>
